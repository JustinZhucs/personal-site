    ...
    return (
        <section id="contact">
            <div className="mx-10 lg:mx-20">
                <p className="mt-10 lg:mt-20 my-8 text-center text-3xl lg:text-6xl">Interested In Working Together?</p>
                <p className="p-4 text-center text-lg lg:text-xl">{CONTACT.text}</p>
